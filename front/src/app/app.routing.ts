...
// import { ProductoIndexComponent } from "./productos/producto-index/producto-index.component";
import { ProductoEditComponent } from "./components/productos/producto-edit/producto-edit.component";
...
import { DashtwoComponent } from "./components/dashtwo/dashtwo.component";
...
const appRoute : Routes = [
    ...
    {path:'dash', component: BarChartComponent},
    {path: 'lista', component: ListaComponent},
    {path: 'productos', component: ProductoIndexComponent},
    {path: 'dashin', component:DashtwoComponent} 
